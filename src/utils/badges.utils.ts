 ...
 */
export function getCurseforgeBadgeVersions(projectId: string): string {
 ...
 */
export function getCurseforgeBadgeDownload(projectId: string): string {
 ...
 * @returns {string} The URL for the badge showing the game versions.
 */
export function getModrinthBadgeVersions(projectId: string): string {
 ...
 * @returns {string} The URL for the badge showing the total downloads.
 */
export function getModrinthBadgeDownload(projectId: string): string {
 ...
 * @returns 
 */
export function getDiscordBadge(serverId: string): string {
